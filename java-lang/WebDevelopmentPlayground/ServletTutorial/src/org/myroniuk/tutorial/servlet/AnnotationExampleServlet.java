...
public class AnnotationExampleServlet extends HttpServlet {
	...
	// In any case, init() is guaranteed to be called before
	// the servlet handles its first request.
	@Override
	...
	protected void doGet(HttpServletRequest request,
		...
		String emailSupport2 = 
				this.getServletConfig().getInitParameter("emailSupport2");
