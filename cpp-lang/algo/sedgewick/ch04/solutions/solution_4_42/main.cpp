/*
 * Exercise 4.42:
 * Given two sequences, give an algorithm for determining whether or not it is possible to add
 * plus signs and asterisks to make the first produce the second when interpreted as a sequence of
 * deque operations in the sense of Exercise 4.41.
 */
